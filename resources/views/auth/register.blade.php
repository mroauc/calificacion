            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="permiso" class="col-md-4 col-form-label text-md-right">{{ __('Permiso') }}</label>

                            <div class="col-md-6">
                                <input id="permiso" type="text" class="form-control @error('permiso') is-invalid @enderror" name="permiso" value="{{ old('permiso') }}" required autocomplete="permiso" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="facultad" type="text" class="form-control @error('facultad') is-invalid @enderror" name="facultad" value="{{ old('facultad') }}" required autocomplete="facultad" autofocus>
